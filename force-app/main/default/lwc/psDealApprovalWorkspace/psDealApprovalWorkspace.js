...
export default class PsDealApprovalWorkspace extends LightningElement {
  steps = [];
  selectedStep;
  selectedApprovalId;
  error;
  ...
  toQueueViewModel(step) {
    return {
      ...step,
      formattedValue: this.formatCurrency(step.estimatedRevenue),
      submittedLabel: this.formatDateTime(step.submittedOn),
      rowClass:
