...
<CustomMetadata xmlns="http://soap.sforce.com/2006/04/metadata" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
    ...
    <values>
        ...
        <value xsi:type="xsd:string">2024-06-01</value>
    </values>
    <values>
        <field>Base_URL__c</field>
        <value xsi:type="xsd:string">/openai/deployments/partnersync/chat/completions</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">PartnerSync_Azure_OpenAI</value>
    </values>
    <values>
        <field>Provider_Name__c</field>
        <value xsi:type="xsd:string">Azure OpenAI</value>
    </values>
    <values>
        <field>Provider_Type__c</field>
        <value xsi:type="xsd:string">AzureOpenAI</value>
    </values>
    <values>
